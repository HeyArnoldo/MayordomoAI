...
export class BoxModeFixedAmount1781501875806 implements MigrationInterface {
  name = 'BoxModeFixedAmount1781501875806';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "boxes" ADD "mode" character varying(10) NOT NULL DEFAULT 'percent'`,
    );
    await queryRunner.query(`ALTER TABLE "boxes" ADD "fixedAmount" numeric(12,2)`);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "boxes" DROP COLUMN "fixedAmount"`);
    await queryRunner.query(`ALTER TABLE "boxes" DROP COLUMN "mode"`);
    await queryRunner.query(
